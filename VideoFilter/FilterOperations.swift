...
#endif
            guard let inputPicture = GPUImagePicture(image: inputImage) else {
                throw MyError.runtimeError("not avaibable inputPicture, please check it")
            }
...
#endif
            guard let blendImage = GPUImagePicture(image: inputImage) else {
                throw MyError.runtimeError("not available blend Image")
            }
...
#endif
            guard let voronoiPointImage = GPUImagePicture(image:voronoiPoints) else {
                throw MyError.runtimeError("voronoiPoints image not available")
            }
